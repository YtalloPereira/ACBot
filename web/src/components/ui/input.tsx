...
const input = tv({
  slots: {
    root: 'group flex w-full items-center bg-border/10 outline-none ring-1 ring-border transition-all focus-within:ring-primary hover:bg-border/25 focus-within:hover:bg-border/10',
    control: 'w-full bg-transparent p-2 outline-none',
  },
