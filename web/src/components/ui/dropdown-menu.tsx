...
export const DropdownMenuSubTrigger = ({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={twMerge(
        'flex items-center justify-between rounded px-1.5 py-0.5 font-medium outline-none hover:cursor-pointer hover:bg-slate-700/10 dark:hover:bg-slate-600/30',
        className,
      )}
      {...props}
    />
...
export const DropdownMenuItem = ({ className, ...props }: DropdownMenuItemProps) => {
  return (
    <DropdownMenuPrimitive.Item
      className={twMerge(
        'flex items-center gap-2 rounded px-1.5 py-0.5 font-medium outline-none hover:cursor-pointer hover:bg-slate-700/10 dark:hover:bg-slate-600/30',
        className,
      )}
      {...props}
    />
...
export const DropdownMenuRadioItem = ({ className, ...props }: DropdownMenuRadioItem) => {
  return (
    <DropdownMenuPrimitive.RadioItem
      className={twMerge(
        'relative flex items-center rounded px-1.5 py-0.5 pl-8 font-medium outline-none hover:cursor-pointer hover:bg-slate-700/10 dark:hover:bg-slate-600/30',
        className,
      )}
      {...props}
    />
